...
var Nav = function (_React$Component) {
  ...
  function Nav(props) {
    ...
    _this.nav = ['tabbed_navigation_wrapper', { hidden: false }];
  ...
  _createClass(Nav, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'tabbed_navigation' },
        React.createElement(
          'a',
          { className: 'osw_l alpha button button_tertiary cardboard menu_trigger',
            href: '#',
        ...
        React.createElement(
          ...
          React.createElement(
            'ul',
            { className: 'menu_navigation tertiary_navigation clearfix' },
